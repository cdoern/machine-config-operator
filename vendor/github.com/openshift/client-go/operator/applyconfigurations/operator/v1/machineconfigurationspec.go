...
type MachineConfigurationSpecApplyConfiguration struct {
	...
	InvisibleMetrics                        []operatorv1.InvisibleMetric `json:"invisibleMetrics,omitempty"`
}
...
func (b *MachineConfigurationSpecApplyConfiguration) WithInvisibleMetrics(values ...operatorv1.InvisibleMetric) *MachineConfigurationSpecApplyConfiguration {
	for i := range values {
