...
func (c *FakeKubeletConfigs) Apply(ctx context.Context, kubeletConfig *machineconfigurationopenshiftiov1.KubeletConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.KubeletConfig, err error) {
...
func (c *FakeKubeletConfigs) ApplyStatus(ctx context.Context, kubeletConfig *machineconfigurationopenshiftiov1.KubeletConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.KubeletConfig, err error) {
	if kubeletConfig == nil {
		return nil, fmt.Errorf("kubeletConfig provided to Apply must not be nil")
	}
	data, err := json.Marshal(kubeletConfig)
