...
func (c *FakeMachineConfigPools) Apply(ctx context.Context, machineConfigPool *machineconfigurationopenshiftiov1.MachineConfigPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfigPool, err error) {
...
func (c *FakeMachineConfigPools) ApplyStatus(ctx context.Context, machineConfigPool *machineconfigurationopenshiftiov1.MachineConfigPoolApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfigPool, err error) {
	if machineConfigPool == nil {
		return nil, fmt.Errorf("machineConfigPool provided to Apply must not be nil")
	}
	data, err := json.Marshal(machineConfigPool)
