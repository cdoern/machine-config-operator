...
func (c *FakeMachineConfigs) Apply(ctx context.Context, machineConfig *machineconfigurationopenshiftiov1.MachineConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfig, err error) {
