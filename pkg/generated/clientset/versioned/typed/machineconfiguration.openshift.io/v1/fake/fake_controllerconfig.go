...
func (c *FakeControllerConfigs) Apply(ctx context.Context, controllerConfig *machineconfigurationopenshiftiov1.ControllerConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ControllerConfig, err error) {
...
func (c *FakeControllerConfigs) ApplyStatus(ctx context.Context, controllerConfig *machineconfigurationopenshiftiov1.ControllerConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ControllerConfig, err error) {
	if controllerConfig == nil {
		return nil, fmt.Errorf("controllerConfig provided to Apply must not be nil")
	}
	data, err := json.Marshal(controllerConfig)
