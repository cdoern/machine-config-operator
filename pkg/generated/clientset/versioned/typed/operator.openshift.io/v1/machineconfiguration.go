...
type MachineConfigurationInterface interface {
	...
	Apply(ctx context.Context, machineConfiguration *operatoropenshiftiov1.MachineConfigurationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfiguration, err error)
	ApplyStatus(ctx context.Context, machineConfiguration *operatoropenshiftiov1.MachineConfigurationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfiguration, err error)
...
func (c *machineConfigurations) Apply(ctx context.Context, machineConfiguration *operatoropenshiftiov1.MachineConfigurationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfiguration, err error) {
...
func (c *machineConfigurations) ApplyStatus(ctx context.Context, machineConfiguration *operatoropenshiftiov1.MachineConfigurationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.MachineConfiguration, err error) {
	if machineConfiguration == nil {
		return nil, fmt.Errorf("machineConfiguration provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
