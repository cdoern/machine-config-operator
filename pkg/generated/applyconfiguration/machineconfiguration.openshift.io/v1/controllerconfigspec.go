...
type ControllerConfigSpecApplyConfiguration struct {
	...
	IPFamilies                     *machineconfigurationopenshiftiov1.IPFamiliesType `json:"ipFamilies,omitempty"`
...
func (b *ControllerConfigSpecApplyConfiguration) WithPullSecret(value v1.ObjectReference) *ControllerConfigSpecApplyConfiguration {
	b.PullSecret = &value
	return b
}
...
func (b *ControllerConfigSpecApplyConfiguration) WithIPFamilies(value machineconfigurationopenshiftiov1.IPFamiliesType) *ControllerConfigSpecApplyConfiguration {
	b.IPFamilies = &value
	return b
}
